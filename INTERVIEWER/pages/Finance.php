        ...
        var questions =["Tell me about yourself.",
                    ...
                    function change() // no ';' here
                    {
                        ...
                        if (nes==5){
                            ...
                            alert(40-((avganger+avgsad+avgfear)*5+(avgdisgust*0.001)+avgattention*1.221))
                              onStop(); 
                        }
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="index.html"><i class="fa fa-dashboard fa-fw"></i>Data Scientist</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Developer<span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li>
                                    <a href=" Android_Developer.html">Android Developer</a>
                                </li>
                                <li>
                                    <a href="Web_Developer.html">Web Developer</a>
                                </li>
                                <li>
                        ...
                        <li>
                            <a href="Data_Analyst.html"><i class="fa fa-table fa-fw"></i>Data Analyst</a>
                        </li>
                        <li>
                            <a href="Finance.html"><i class="fa fa-edit fa-fw"></i>Finance</a>
                        </li>
      ...
      detector.addEventListener("onImageResultsSuccess", function(faces, image, timestamp) {
        ...
        if (faces.length > 0) {
          ...
          console.log('#results', "disgust: " + JSON.stringify(faces[0].emotions["disgust"], function(key, val) {
            ...
            console.log("totdisgust",totdisgust);
            return val.toFixed ? Number(val.toFixed(0)) : val;
          }));
          ...
          console.log('#results', "attention: " + JSON.stringify(faces[0].expressions["attention"], function(key, val) {
            ...
            console.log("totattention",totattention);
            return val.toFixed ? Number(val.toFixed(0)) : val;
          }));
